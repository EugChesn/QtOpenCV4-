...
modules/videoio/precomp.hpp.gch/opencv_videoio_Release.gch: C:/OpenCv/opencv/sources/modules/videoio/src/precomp.hpp
...
modules/videoio/precomp.hpp.gch/opencv_videoio_Release.gch: lib/libopencv_videoio_pch_dephelp.a
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --blue --bold --progress-dir=C:\OpenCv\opencv\opencv_bin\CMakeFiles --progress-num=$(CMAKE_PROGRESS_1) "Generating precomp.hpp.gch/opencv_videoio_Release.gch"
	cd /d C:\OpenCv\opencv\opencv_bin\modules\videoio && "C:\Program Files (x86)\CMake\bin\cmake.exe" -E make_directory C:/OpenCv/opencv/opencv_bin/modules/videoio/precomp.hpp.gch
	cd /d C:\OpenCv\opencv\opencv_bin\modules\videoio && E:\Qt\Tools\mingw730_32\bin\g++.exe -O3 -DNDEBUG -DNDEBUG "-D__OPENCV_BUILD=1" "-D_USE_MATH_DEFINES" "-D__STDC_CONSTANT_MACROS" "-D__STDC_LIMIT_MACROS" "-D__STDC_FORMAT_MACROS" -std=c++11 -isystem"C:/OpenCv/opencv/opencv_bin" -isystem"C:/OpenCv/opencv/opencv_bin" -I"C:/OpenCv/opencv/sources/modules/videoio/src" -I"C:/OpenCv/opencv/sources/modules/videoio/include" -I"C:/OpenCv/opencv/opencv_bin/modules/videoio" -I"C:/OpenCv/opencv/sources/modules/core/include" -I"C:/OpenCv/opencv/sources/modules/imgproc/include" -I"C:/OpenCv/opencv/sources/modules/imgcodecs/include" -fsigned-char -W -Wall -Werror=return-type -Werror=non-virtual-dtor -Werror=address -Werror=sequence-point -Wformat -Werror=format-security -Wmissing-declarations -Wundef -Winit-self -Wpointer-arith -Wshadow -Wsign-promo -Wuninitialized -Winit-self -Wno-delete-non-virtual-dtor -Wno-comment -Wimplicit-fallthrough=3 -Wno-strict-overflow -fdiagnostics-show-option -fomit-frame-pointer -ffunction-sections -fdata-sections -msse -msse2 -mfpmath=sse -fvisibility=hidden -fvisibility-inlines-hidden -I"C:/OpenCv/opencv/sources/modules/videoio/src" -DCVAPI_EXPORTS -x c++-header -o C:/OpenCv/opencv/opencv_bin/modules/videoio/precomp.hpp.gch/opencv_videoio_Release.gch C:/OpenCv/opencv/opencv_bin/modules/videoio/precomp.hpp

modules/videoio/precomp.hpp: C:/OpenCv/opencv/sources/modules/videoio/src/precomp.hpp
	...
	cd /d C:\OpenCv\opencv\opencv_bin\modules\videoio && "C:\Program Files (x86)\CMake\bin\cmake.exe" -E copy_if_different C:/OpenCv/opencv/sources/modules/videoio/src/precomp.hpp C:/OpenCv/opencv/opencv_bin/modules/videoio/precomp.hpp
...
modules/videoio/CMakeFiles/pch_Generate_opencv_videoio.dir/clean:
	cd /d C:\OpenCv\opencv\opencv_bin\modules\videoio && $(CMAKE_COMMAND) -P CMakeFiles\pch_Generate_opencv_videoio.dir\cmake_clean.cmake
...
modules/videoio/CMakeFiles/pch_Generate_opencv_videoio.dir/depend:
	$(CMAKE_COMMAND) -E cmake_depends "MinGW Makefiles" C:\OpenCv\opencv\sources C:\OpenCv\opencv\sources\modules\videoio C:\OpenCv\opencv\opencv_bin C:\OpenCv\opencv\opencv_bin\modules\videoio C:\OpenCv\opencv\opencv_bin\modules\videoio\CMakeFiles\pch_Generate_opencv_videoio.dir\DependInfo.cmake --color=$(COLOR)
